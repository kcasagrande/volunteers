...
class LevenshteinDistanceDP {
    ...
    public  static  boolean asAcceptedMissspell(String str1, String str2){
        Long acceptedMissSpell = Math.round(str1.length()*.1)+1;
        if (str1.isEmpty() || str2.isEmpty()){
            return false;
        }else if(compute_Levenshtein_distanceDP(str1,str2) <= acceptedMissSpell){
            return true;
        }
        return false;
