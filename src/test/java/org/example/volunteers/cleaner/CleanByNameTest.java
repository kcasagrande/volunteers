...
public class CleanByNameTest {
  ...
  public static Object[][] dataProviderVolunteersWithSameName() {
    ...
    String[][] volunteersData2 = new String[][]{
        {"Benoît", "Beaudouin", "bebe", "", "+33099395922"},
        {"Benoît", "Beaudouin", "", "", "+33099395922"},
        {"Benoît", "Beaudouin", "bebe", "", "+33099395922"},
        {"Benoît", "Beaudouin", "", "benoit_beaudoin@example.org", "+33099395922"},
    };
  ...
  @DataProvider
  public static Object[][] dataProviderVolunteersWithDifferentName() {
    String[][] volunteersData1 = new String[][]{
  ...
  @Test
  @UseDataProvider(value = "dataProviderVolunteersWithSameName")
  public void shouldDedupeAndMergeVolunteersWithSameNameAndOneCredentials(
      List<Volunteer> volunteers,
      List<Volunteer> expectedDedupedAndMergedList
  ) {
    // When
    ArrayList<Volunteer> cleanedList = Cleaner.mergeByName(volunteers);
  ...
  @Test
  @UseDataProvider(value = "dataProviderVolunteersWithDifferentName")
  public void shouldNotDedupeAndMergeVolunteersWithDifferentNameOrCredentials(List<Volunteer> volunteers) {
    // When
